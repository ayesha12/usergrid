...
public class TargetDirectedEdgeDescendingComparatorTest {
    ...
    public void uuidDifferent() {
        ...
        final SimpleMarkedEdge markedEdge1 = new SimpleMarkedEdge( sourceId, type, targetId1, timestamp, true, timestamp -1L );
        final SimpleMarkedEdge markedEdge2 = new SimpleMarkedEdge( sourceId, type, targetId2, timestamp, true, timestamp -1L );
    ...
    public void idTypeDifferent() {
        ...
        final SimpleMarkedEdge markedEdge1 = new SimpleMarkedEdge( sourceId, type, targetId2, timestamp, true, timestamp-1L );
        final SimpleMarkedEdge markedEdge2 = new SimpleMarkedEdge( sourceId, type, targetId1, timestamp, true , timestamp-1L );
