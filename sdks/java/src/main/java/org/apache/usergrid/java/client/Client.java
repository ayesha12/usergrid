...
public class Client {
   ...
   */
  public UsergridUser getLoggedInUser() {
    return loggedInUser;
  }
   ...
   */
  public void setLoggedInUser(UsergridUser loggedInUser) {
  ...
  public UsergridResponse authorizeAppClient(String clientId, String clientSecret) {
    ...
    if (!isEmpty(response.getAccessToken())) {
      ...
      accessToken = response.getAccessToken();
      currentOrganization = null;
      log.info("Client.authenticateApp(): Access token: "
          + accessToken);
    } else {
  ...
  public UsergridResponse updateEntity(UsergridEntity e) {
    ...
    String name = e.getStringProperty("getName");
  ...
  public UsergridResponse postUserActivity(String verb, String title,
                                           String content, String category, UsergridUser user, UsergridEntity object,
