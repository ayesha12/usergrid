...
//
//  public static UsergridResponse fromString(String q1){
//
//
//    QueryResult client = Usergrid.getInstance().GET(q1);
////    qparam.put("access_token",client.getAccessToken());
////    return client.apiRequest("GET",qparam,null,client.getOrgId(),client.getAppId());
//  }
      ...
      for (int i = 0; i < this.requirements.size(); i++) {
        ...
        if (i > 0) {
          ...
          if(this.requirements.get(i) == OR || this.requirements.get(i) == NOT){
            ...
            if(this.requirements.get(i-1) != NOT)
