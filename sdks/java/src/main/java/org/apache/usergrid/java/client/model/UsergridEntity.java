...
public class UsergridEntity {
  ...
  public static final String STR_NAME = "getName";
  ...
  public void setName(String name){ setStringProperty(properties,STR_NAME,name); }
  public String getName() { return getStringProperty(STR_NAME); }

  public void setCreated(Long cTimeStamp){ setLongProperty(properties,CREATED_TIMESTAMP, cTimeStamp) ; }
  public Long getCreated() { return  getEntityProperty(CREATED_TIMESTAMP); }

  public void setModified(Long modified) {setLongProperty(properties,MODIFIED_TIMESTAMP,modified);}
  public Long getmodified() { return  getEntityProperty(MODIFIED_TIMESTAMP); }
   ...
   * @throws JSONException
   */
  public void putProperties(Map<String,JsonNode> jsonHash) throws JSONException {
