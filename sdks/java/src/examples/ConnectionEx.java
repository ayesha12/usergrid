...
public class ConnectionEx {
    ...
    public static void main(String[] args) throws ScriptException {
        ...
        System.out.println("test : " +  t.get("getName"));

        JsonNode personName = t.get("getName");


        System.out.println(c1.getLastEntity().getStringProperty("getName"));
        ...
        System.out.println(usergridEntity1.getStringProperty("getName"));
